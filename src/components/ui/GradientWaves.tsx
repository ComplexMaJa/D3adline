...
export const GradientWaves: React.FC<GradientWavesProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('GradientWaves: WebGL 2 is not supported or failed to initialize', e);
      return;
    }
    ...
    // Attach to window so parallax reacts seamlessly across entire hero surface
